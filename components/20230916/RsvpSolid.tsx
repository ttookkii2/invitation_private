...
const RSVPSolid = () => {
  ...
  return (
    <form
      id="rsvp"
      className="flex w-full pb-20 px-10 mb-20 flex-col rounded-sm bg-beige gap-2 relative"
      onSubmit={submitForm}
    >
      <ToastContainer
        className="h-3"
        ...
        theme="light"
      />
      <Title subTitle="rsvp" mainTitle="참석 의사 전달" />
      <p className="text-base text-center whitespace-pre pb-3 leading-snug">{`감사의 마음으로\n모든 분들을 귀하게 모실 수 있도록\n참석 의사를 전달 부탁드립니다.`}</p>
