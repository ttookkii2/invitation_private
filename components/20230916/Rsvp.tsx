...
const RSVPForm = () => {
  ...
  return (
    ...
    >
      ...
      />
      <form
        className="flex w-full max-w-sm p-10 py-15 flex-col rounded-sm bg-white gap-2 relative"
        onSubmit={submitForm}
      >
        <Image
          src={closeIcon}
        ...
        />
        <p className="text-xl text-center mb-2">참석 의사 전달</p>
        <p className="text-sm text-center whitespace-pre pb-3 leading-snug">{`감사의 마음으로\n모든 분들을 귀하게 모실 수 있도록\n참석 의사를 전달 부탁드립니다.`}</p>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex justify-center w-[60%] transition-all duration-300 gap-4">
            <button
              type="button"
              className={`px-2 transition-[border] text-xs mobile:text-sm h-8 py-1 border-[1px] w-1/2 rounded-md ${
                form.attending === true
            ...
            <button
              type="button"
              className={`px-2 transition-[border] text-xs mobile:text-sm h-8 py-1 w-1/2 border-[1px] rounded-md ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex justify-center w-[60%] transition-all duration-300 gap-4">
            <button
              type="button"
              className={`px-2 text-xs mobile:text-sm h-8 py-1 w-1/2 border-[1px] rounded-md ${
                form.side === "bride"
